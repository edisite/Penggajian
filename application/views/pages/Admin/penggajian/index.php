					...
					<div class="card">
                                                <div class="card-header">
                                                        <div class="row">
                                                                ...
                                                                <form action="<?php echo base_url().'admin/penggajian'; ?>" method="get">                                        
									...
									<tbody>
										...
										foreach ($penggajian as $data) : ?>
											<tr>
												...
												<td>
													<a href="<?php echo base_url('admin/penggajian/download/') . $data->id_penggajian ?>" class="btn btn-info" title="Print PDF"><i class="fa fa-print"></i> </a>
													<?php 
														if (date('Y-m') == $data->periode_bulan){
															?>
