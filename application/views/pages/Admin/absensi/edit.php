                            ...
                            <?php foreach ($absensi as $data) : ?>
                                <form method="post" class="needs-validation" action="<?php echo site_url('admin/absensi/update') ?>" novalidate="">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="month" class="form-control" id="date" name="datetrans" value="<?php echo $data->periode_tanggal; ?>">
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        <label for="terlambat">Terlambat <span class="small text-danger pull-right"> *Menit</span></label>
                                        <input id="terlambat" type="number" class="form-control" value="<?= $data->terlambat ?>" name="terlambat" tabindex=" 1" required>
                                        <div class="invalid-feedback">
                                            Masukkan jumlah terlambat terlebih dahulu
                                        </div>
                                    </div>
                                    <div class="form-group">
